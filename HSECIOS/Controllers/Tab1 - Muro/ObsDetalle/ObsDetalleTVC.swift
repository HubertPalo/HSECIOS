...
class ObsDetalleTVC: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        /* Datos a usar en tabla comentarios de Tarea
    ...
    func reloadValues(){
        ...
        //obsSubDetalleDict = ["PREA":[], "PETO":[], "OBSR":[], "OBSC":[], "OBCC":[], "HHA":[]]
        obsSubDetalleDict = [:]
        ...
        for i in 0..<obsSubDetalle.count {
            ...
            //obsSubDetalleDict[obsSubDetalle[i].CodTipo]?.append(obsSubDetalle[i])
        }
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        if observacion.Tipo == "TO03" {
            return 5
        } else if observacion.Tipo == "TO04" {
            return 7
        } else {
            return 1
        }
