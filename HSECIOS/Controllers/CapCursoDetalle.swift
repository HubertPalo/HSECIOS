//
//  CapCursoDetalle.swift
//  HSECIOS
//
//  Created by Mac01 on 23/07/18.
//  Copyright © 2018 pangolabs. All rights reserved.
//

import UIKit
//, UITabBarDelegate, UITableViewDelegate, UITableViewDataSource , UIViewController
